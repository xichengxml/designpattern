...
/**
 * description jdk动态代理原理分析：缺点，代理的类必须实现某个接口
 ...
 */
public class T06_Proxy06 {

    public static void main(String[] args) {
        // jdk8及之前的设置 System.setProperty("sun.misc.ProxyGenerator.saveGeneratedFiles", "true")；
...
@Data
@AllArgsConstructor
class TankLog05 implements InvocationHandler {
...
@Data
@AllArgsConstructor
class TankRunTime05 implements InvocationHandler {
